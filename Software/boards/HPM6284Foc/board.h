...
/* drv8323 */
#define BOARD_DRV8323_SPI_BASE HPM_SPI3
#define BOARD_DRV8323_SPI_CLK_NAME clock_spi3
#define BOARD_DRV8323_SPI_SCLK_FREQ         (10000000UL)
#define BOARD_DRV8323_SPI_DATA_LEN_IN_BITS  (8U)
#define BOARD_DRV8323_PIN_PWM_EN IOC_PAD_PZ00
#define BOARD_DRV8323_PIN_CAL IOC_PAD_PZ02
#define BOARD_DRV8323_PIN_nFAULT IOC_PAD_PB26
